  ...
  return (
    ...
    >
      <div className="relative aspect-video w-full overflow-hidden bg-black">
        ...
        {article.duration && (
          <Badge className="absolute bottom-3 end-3 bg-black/70 text-white backdrop-blur">
            {article.duration}
          </Badge>
        )}
        <Badge variant="secondary" className="absolute start-3 top-3 bg-background/80 backdrop-blur">
