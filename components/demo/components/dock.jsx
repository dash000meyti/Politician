...
export function DockDemo() {
  return (
    <div className="relative">
      <Dock direction="bottom" className="space-x-3 px-3" iconMagnification={72} iconDistance={140}>
        <DockIcon className="bg-white dark:bg-black border-2 rounded-md">
