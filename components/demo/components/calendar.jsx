...
import { Calendar, CalendarDayButton, CalendarPersian } from "@/components/ui"
...
export function CalendarDemoHijri() {
  const [date, setDate] = React.useState(new Date())
...
export function CalendarDemoTime() {
  const [date, setDate] = React.useState(
...
export function CalendarDemoBooked() {
  const [date, setDate] = React.useState(
